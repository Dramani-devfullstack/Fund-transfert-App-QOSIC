                    ...
                    <div className="col-lg-6 col-md-12">
                      <div className="form-tab">
                        <ul className="nav nav-tabs">
                          <li><a  onClick={()=>setActive('sendmoney') } className={ active ==='sendmoney' ? "active" : "nav nav-tabs a"}  data-toggle="tab">NGN to XOF</a></li>
                          <li ><a  onClick={()=>setActive('receivemoney')}   className={ active ==='receivemoney' ? "active" : "nav nav-tabs a"}    data-toggle="tab" >XOF to NGN</a></li>
                        </ul>
